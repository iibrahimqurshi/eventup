        ...
        <div className="tabs_wrapper">
          <ul className="nav" role="tablist">
            <li role="presentation">
              <button className="active" data-bs-toggle="tab" data-bs-target="#teb_all" type="button" role="tab" aria-selected="true">
                <span>All</span>
              </button>
            </li>
            <li role="presentation">
              <button data-bs-toggle="tab" data-bs-target="#teb_arts" type="button" role="tab" aria-selected="false">
              <i class="fas fa-palette"></i>
                  <span>ARTS & THEATRE</span>
              </button>
            </li>
            <li role="presentation">
              <button data-bs-toggle="tab" data-bs-target="#teb_music" type="button" role="tab" aria-selected="false">
              <i class="fas fa-music"></i>
                  <span>MUSIC & CONCERTS</span>
              </button>
            </li>
            <li role="presentation">
              <button data-bs-toggle="tab" data-bs-target="#teb_sports" type="button" role="tab" aria-selected="false">
              <i class="fas fa-chart-network"></i>
                  <span>SPORTS & WELLNESS</span>
              </button>
            </li>
            <li role="presentation">
              <button data-bs-toggle="tab" data-bs-target="#teb_tech" type="button" role="tab" aria-selected="false">
              <i class="fas fa-lightbulb-on"></i>
                  <span>TECH & INNOVATION</span>
              </button>
            </li>
            <li role="presentation">
              <button data-bs-toggle="tab" data-bs-target="#teb_education" type="button" role="tab" aria-selected="false">
              <i class="fas fa-palette"></i>
                  <span>WORKSHOPS & EDUCATION</span>
              </button>
            </li>
            <li role="presentation">
              <button data-bs-toggle="tab" data-bs-target="#teb_social" type="button" role="tab" aria-selected="false">
              <i class="fas fa-users"></i>
                  <span>SOCIAL GATHERING
                  </span>
              </button>
            </li>
          </ul>
            ...
            <div className="col col-lg-4">
              <div className="event_card">
                <div className="item_image">
                  <Link to="/event-details"> {/* Replace with <a href="..."> if not using React Router */}
                ...
                <div className="item_content">
                  <div className="d-flex align-items-center justify-content-between mb-3">
                    <ul className="item_category_list unordered_list">
                      <li><Link to="#">ARTS & THEATRE</Link></li> {/* Replace with <a href="..."> if not using React Router */}
                    </ul>
                  ...
                  <h3 className="item_title">
                    <Link to="/event_details">Canvas & Cocktails</Link> {/* Replace with <a href="..."> if not using React Router */}
                    <p className="small">Unwind and create art in a relaxed, social setting.</p>
                  </h3>
                  ...
                  <Link className="btn_unfill" to="/event_details"> {/* Replace with <a href="..."> if not using React Router */}
